...
router.get('/getMediaMedicionesUsuario/:idUsuario', medicionControlador.getMediaMedicionesUsuario);
router.get('/getAllMedicionesUsuario/:idUsuario', medicionControlador.getAllMedicionesUsuario);
